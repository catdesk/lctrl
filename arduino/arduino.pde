#include </usr/share/arduino/libraries/aikocustom/AikoTiming.h>
#include </usr/share/arduino/libraries/aikocustom/AikoCallback.h>
#include </usr/share/arduino/libraries/aikocustom/AikoEvents.h>
...
void setup() {
  ...
  Aiko::Events.addHandler(userInput, 100);
  Aiko::Events.addHandler(fade, 25);
}
